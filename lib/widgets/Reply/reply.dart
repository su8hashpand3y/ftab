...
import 'package:flutter_tab/widgets/Reply/replyMessageWidget.dart';
...
class ReplyWidgetState extends State<ReplyWidget> {
  ...
  Future _loadData() async {
    final res = await Internet
        .get('http://127.0.0.1:58296/Message/GetReplyMessageCard?lastId=${this._data.length > 0 && this._data.last != null ? this._data.last.lastId : 0}');
    if (res.status == 'bad') {
      showDialog(
          context: context,
